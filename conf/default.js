...
module.exports = {
	...
	admin: {
		...
		validEmails: ["denodenodeno@gmail.com"],
	...
	session: {
		...
		encryptionKey: 'yrsulJVojqOmSmMpdMOdFJhl/WEYSmdxHWI0AxdMGW4=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'KzXdAuKudYKGhFp5zpxvdarea/anxGa1RKapy90CwOA/j+vAA1klR6XAIJ4suTQLCSriTdUDjPLXwvtcbotZIg==',
		secret: 'pdKsixRflY/m94TxT0XRPj/athvWwvHc', // should be a large unguessable string
	...
	cookieSecret: 'pnCKzKTgfzmY/dYhybVdVZbx2rpnrZKG',
